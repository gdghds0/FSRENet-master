...
parser.add_argument('--exp', type=str,  default='FSRENET_LA', help='exp_name')
parser.add_argument('--model', type=str,  default='fvnet', help='model_name')
...
snapshot_path = "../model/{}_{}/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
test_save_path = "./model/{}_{}/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
num_classes = 2
...
def test_calculate_metric():
    model = net_factory_3d(net_type=FLAGS.model, in_chns=1, class_num=num_classes)
    
    save_model_path = save_mode_path
