...
parser.add_argument('--exp', type=str,
                    default='FSRENet', help='experiment_name')
...
def compute_unsupervised_loss(predict, target, percent, pred_teacher):
    ...
    loss = weight * Rdice_loss(soft_predict, target.unsqueeze(1), ignore_index=255)  # [10, 321, 321]
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if args.fsm:
                ...
                intra_loss134, intra_cd134 = FSM_Ahasim(o13[args.labeled_bs:], o14[args.labeled_bs:], args.balance)

                intra_loss234, intra_cd234 = FSM_Ahasim(o23[args.labeled_bs:], o24[args.labeled_bs:], args.balance)

                intra_loss334, intra_cd334 = FSM_Mixsim(o13[args.labeled_bs:], o23[args.labeled_bs:], o14[args.labeled_bs:], o24[args.labeled_bs:], args.balance)
            ...
            if iter_num > 0 and iter_num % 4 == 0:
                model1.eval()
                metric_list = 0.0
